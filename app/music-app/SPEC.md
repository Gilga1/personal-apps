...
A private, ad-free, local-first desktop music player for a mixed FLAC/MP3 collection. This document captures the implementation spec for `app/music-app`, derived from the architecture write-up and the `stacks-cozy` browser prototype.
